        ...
        return (
            <div id="home-category">
                ...
                <div className="index-container">
                    <ul>
                        <li className={this.state.categoryIndex === 0 ? "selected" : ''}></li>
                        <li className={this.state.categoryIndex === 1 ? "selected" : ''}></li>
                        <li className={this.state.categoryIndex === 2 ? "selected" : ''}></li>
                    </ul>
                </div>
            </div>
        )
